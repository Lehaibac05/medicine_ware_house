...
export type InventoryFilter = {
  ...
  medicineName: string;
  status: string;
  expiryDateRange: [Dayjs | null, Dayjs | null] | null;
};
...
const InventoryPage = () => {
  ...
  const [expiryDateRange, setExpiryDateRange] = useState<[Dayjs | null, Dayjs | null] | null>(null);
  const [appliedFilter, setAppliedFilter] = useState<InventoryFilter>({
    warehouse: "all",
    medicineName: "",
    status: "all",
    ...
    <Layout className="min-h-screen bg-slate-100">
      ...
      <Layout className="lg:ml-[260px]">
        ...
        <Content className="flex flex-col gap-6 p-6 pt-[114px]">
          ...
          <BaseFilterCard
            actions={
              <Button type="primary" className="h-[40px]" onClick={handleApplyFilter}>
                Apply
              </Button>
            }
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <DatePicker.RangePicker 
                ...
                onChange={(dates) => setExpiryDateRange(dates)}
              />
            </div>
          </BaseFilterCard>

          <InventoryTable filter={appliedFilter} />
        </Content>
      </Layout>
    </Layout>
  );
