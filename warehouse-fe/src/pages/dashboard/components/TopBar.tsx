...
function TopBar({ title = 'Inventory', subtitle = 'Warehouse' }: TopBarProps) {
  ...
  return (
    <Header className="!h-[90px] !bg-white px-6 py-4 border-b border-slate-200 flex flex-wrap items-center justify-between gap-6">
      ...
      <div className="flex flex-1 flex-col items-stretch gap-3 md:flex-row md:items-center md:justify-end">
        ...
        <div className="flex items-center gap-3 rounded-full border border-slate-200 bg-slate-50 px-3 py-0.5">
